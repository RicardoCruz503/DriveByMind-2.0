...
public class MatLab_Env_Comando : MonoBehaviour {
	...
	void Start ()
	{
		modo1.gameObject.GetComponent<GUIText>().text = "" + modo1Valor;
		modo2.gameObject.GetComponent<GUIText>().text = "" + modo2Valor;
		ini_estimulo.gameObject.GetComponent<GUIText>().text = "" + ini_estimuloValor;
		ini_calibracao.gameObject.GetComponent<GUIText>().text = "" + ini_calibracaoValor;
	}
