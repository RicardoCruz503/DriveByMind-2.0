...
public class MatLab_Calib_Freq : MonoBehaviour {
	...
	void Start ()
	{
		freq1.gameObject.GetComponent<GUIText>().text = "" + freq1Valor;
		freq2.gameObject.GetComponent<GUIText>().text = "" + freq2Valor;
		freq3.gameObject.GetComponent<GUIText>().text = "" + freq3Valor;
		freq4.gameObject.GetComponent<GUIText>().text = "" + freq4Valor;
		freq5.gameObject.GetComponent<GUIText>().text = "" + freq5Valor;
		freq6.gameObject.GetComponent<GUIText>().text = "" + freq6Valor;
		freq7.gameObject.GetComponent<GUIText>().text = "" + freq7Valor;
	}
