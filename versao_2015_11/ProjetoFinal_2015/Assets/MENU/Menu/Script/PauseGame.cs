				...
				if (Input.GetKeyUp (KeyCode.Escape)) {
						if (pause == true) {
								...
								if (HelicopteroTecladoScene || HelicopteroGusbampScene || HelicopteroLivre) {
										GameObject.Find ("Helicoptero").GetComponent<AudioSource>().Play ();
								}
								...
								if (Carros3DTecladoScene || Carros3DGusbampScene || Taxi3DTecladoScene || Taxi3DGusBampScene) {
										GameObject.Find ("TAXI").GetComponent<AudioSource>().Play ();
								}
								Time.timeScale = 1.0f;
								...
								if (HelicopteroTecladoScene || HelicopteroGusbampScene || HelicopteroLivre) {
										GameObject.Find ("Helicoptero").GetComponent<AudioSource>().Pause ();
								}
								if (Carros2DTecladoScene || Carros2DMindwaveScene || Carros2DAndroid) {
										GameObject.Find ("Camera").GetComponent<AudioSource>().Pause ();
								}
								if (Carros3DTecladoScene || Carros3DGusbampScene || Taxi3DTecladoScene || Taxi3DGusBampScene) {
										GameObject.Find ("TAXI").GetComponent<AudioSource>().Pause ();
								}
								Time.timeScale = 0.0f;
								pause = true;
						} 
