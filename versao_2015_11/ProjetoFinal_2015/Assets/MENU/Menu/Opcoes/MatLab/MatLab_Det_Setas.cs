...
public class MatLab_Det_Setas : MonoBehaviour
{
		...
		void Start ()
		{
		Esquerda.gameObject.GetComponent<GUIText>().text = "" + EsqValor;
		Direita.gameObject.GetComponent<GUIText>().text = "" + DirValor;
		Frente.gameObject.GetComponent<GUIText>().text = "" + FrenteValor;
		Tras.gameObject.GetComponent<GUIText>().text = "" + TrasValor;
		}
