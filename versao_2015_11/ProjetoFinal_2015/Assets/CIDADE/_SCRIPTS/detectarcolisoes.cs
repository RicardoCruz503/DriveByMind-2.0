...
public class detectarcolisoes : MonoBehaviour {
	...
	void Start () {
		GameObject.Find("particulasEliporto").GetComponent<ParticleSystem>().Stop();
	...
	void OnTriggerEnter(Collider colisao) {
		...
		if (colisao.gameObject.name == "ColliderBebe1") {
			bebe1Movimento = true;
			GameObject.Find("particulasEliporto").GetComponent<ParticleSystem>().Play();
		}
		...
		if (colisao.gameObject.name == "ColliderHeliporto") {
			...
			if (bebe1Movimento == true){
				GameObject.Find("particulasBebe1").GetComponent<ParticleSystem>().Stop();
			...
			if (bebe2Movimento == true){
				GameObject.Find("particulasBebe2").GetComponent<ParticleSystem>().Stop();
			...
			if (bebe3Movimento == true){
				GameObject.Find("particulasBebe3").GetComponent<ParticleSystem>().Stop();
