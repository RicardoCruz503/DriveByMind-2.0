				...
				if (TCPServer.connect == true) {
					...
					/*	if (EnviarMatLabModoJogo == true && tempo > 10) { // Cada vez que se perde ligaçao e retoma, envia um pedido de jogo modo2 (1 em 1s)
						...
						if (AnimViajante.SeguirCarro == true) {
								...
								TextoPontos.GetComponent<GUIText>().text = Pontuacao.ToString ();
			
								//Tempo de jogo no ecra
								TempoGUI.GetComponent<GUIText>().text = niceTime;
								...
								if (viajanteABordo == false) {
										...
										GameObject.Find ("EstadoDir").GetComponent<Renderer>().material = TaxiLivre;
										GameObject.Find ("EstadoEsq").GetComponent<Renderer>().material = TaxiLivre;
								} else {
										...
										GameObject.Find ("EstadoDir").GetComponent<Renderer>().material = TaxiOcupado;
										GameObject.Find ("EstadoEsq").GetComponent<Renderer>().material = TaxiOcupado;
								}
								DistanciaGUI.GetComponent<GUIText>().text = distanciaViaj + "m";
